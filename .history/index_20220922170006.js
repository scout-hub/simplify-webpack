 ...
 * @LastEditors: Zhouqi
 * @LastEditTime: 2022-09-22 16:59:07
 */
import fs from 'fs';
...
const resolveInputDep = (filePath) => {
    ...
    traverse.default(ast, {
        ImportDeclaration({
            ...
            // 处理文件的路径
            console.log(filePath, path.resolve('./src', node.source.value));
            path.relative(process.cwd(), path.resolve(__dirnameNew, node.source.value))
